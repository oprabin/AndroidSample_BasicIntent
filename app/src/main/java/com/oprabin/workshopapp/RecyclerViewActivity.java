...
public class RecyclerViewActivity extends AppCompatActivity {
    ...
    private void getInformation(){
        ...
        for(int i=0; i<titles.length; i++){
            ...
            information.setName(titles[i]);
            information.setDescription(descriptions[i]);
            information.setImage(images[i]);
        ...
        ContentAdaptor contentAdaptor = new ContentAdaptor(informationArrayList);
